      ...
      <main role="main">
  			<div class="card mb-12 box-shadow">
                ...
                <div class="card-body">
                  ...
                  <h3>Propietario : ${userOwner.nombre}</h3>
                   <p class="card-text">${inmueble.direccion}</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    
                      <button type="button" onclick="location.href ='<%=request.getContextPath()%>/user/menu';" class="btn btn-outline-secondary">REGRESAR</button>
                    </div>
